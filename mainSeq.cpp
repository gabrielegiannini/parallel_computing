...
int main(int argc, char *argv[])
{
    ...
    cout << "" << endl;
    cout << "Completion time ngramsSEQ: " << ngrams_time << "µs" << endl;
    ...
    cout << "" << endl;
    cout << "Throughput ngramsSEQ: " << 1.0 / (1.0 * ngrams_time / total_ngrams_analyzed) << " operations executed in 1/Service time" << endl;
